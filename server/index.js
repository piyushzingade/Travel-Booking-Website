...
app.get('/addPackages' , async(req, res)  => {
  ...
  },
  {
    ...
    rating: 4.9,
    duration: "6 days",
    description1: "Relax in the beautiful white-washed buildings and blue-domed churches of Santorini.",
    description2: "Santorini, with its iconic blue-domed churches, whitewashed houses, and stunning sunsets, is a paradise for travelers seeking tranquility and beauty. Over 6 days, you’ll explore the island’s charming villages like Oia and Fira, swim in the crystal-clear waters of the Aegean Sea, and enjoy a boat trip to the volcanic islands. Savor delicious Greek cuisine at seaside tavernas, relax on the black sand beaches, and take in the breathtaking views from the caldera. Santorini is the perfect destination for those looking for a romantic and unforgettable escape.",
    imageUrl: "https://images.pexels.com/photos/163407/santorini-oia-village-greece-163407.jpeg?auto=compress&cs=tinysrgb&w=600"
  },
...

  {
    ...
    rating: 4.8,
    duration: "6 days",
    description1: "Enjoy stunning views and serene beauty in Santorini, Greece.",
    description2: "Santorini, with its picturesque white-washed houses and iconic blue-domed churches, offers a tranquil and enchanting experience. This 6-day tour lets you unwind in the beauty of the Aegean Sea, explore the charming villages of Oia and Fira, and enjoy breathtaking sunsets over the caldera. Savor Greek cuisine at local tavernas, relax on black sand beaches, and take a boat trip to nearby volcanic islands. Perfect for couples and solo travelers, Santorini will leave you spellbound with its beauty and serenity.",
